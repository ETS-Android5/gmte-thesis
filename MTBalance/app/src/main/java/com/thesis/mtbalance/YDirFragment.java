...
public class YDirFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_ydir, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        AnyChartView plotView = view.findViewById(R.id.plot_ydir);

        // Set the plotView background during loading + loading icon
        plotView.setBackgroundColor(backgroundColor);
        ProgressBar progressBar = view.findViewById(R.id.progress_ydir);
        ...
        scatter.xAxis(0).title("Ride time (sec)");
